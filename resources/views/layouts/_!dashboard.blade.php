            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-success text-white" href=""><i
                        ...
                        <ul class="sidebar-menu list-group">
                            ...
                            @if (!$user->is_user())
                                ...
                                <li class="{{ request()->is('dashboard/employer*') ? 'active' : '' }}">
                                    ...
                                    <ul class="dropdown-menu" style="display: none;">
                                        ...
                                        <li><a class="sidebar-link" href="">@lang('app.posted_jobs')</a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.applicants')</a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.shortlist')</a></li>
                            ...
                            @if ($user->is_admin())
                                ...
                                <li class="{{ request()->is('dashboard/jobs*') ? 'active' : '' }}">
                                    ...
                                    <ul class="dropdown-menu" style="display: none;">
                                        <li><a class="sidebar-link" href="">@lang('app.pending') <span
                                                    class="badge badge-success float-right">{{ $pendingJobCount }}</span></a>
                                        </li>
                                        <li><a class="sidebar-link" href="">@lang('app.approved') <span
                                                    class="badge badge-success float-right">{{ $approvedJobCount }}</span>
                                            </a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.blocked') <span
                                ...
                                <li class="{{ request()->is('dashboard/cms*') ? 'active' : '' }}">
                                    ...
                                    <ul class="dropdown-menu" style="display: none;">
                                        <li><a class="sidebar-link" href="">@lang('app.pages')</a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.posts')</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="{{ request()->is('dashboard/settings*') ? 'active' : '' }}">
                                    ...
                                    <ul class="dropdown-menu" style="display: none;">
                                        <li><a class="sidebar-link" href="">@lang('app.general_settings')</a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.pricing')</a></li>
                                        <li><a class="sidebar-link" href="">@lang('app.gateways')</a></li>
                                    </ul>
                                </li>
