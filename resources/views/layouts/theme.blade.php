              ...
              @if ($user->is_user() || $user->is_employer())
                ...
                <li class="nav-mobile has-submenu">
                  ...
                  <ul class="submenu" style="display: none;">
                    <li><a href="">{{ __('app.profile_settings') }}</a></li>
           ...
           <ul>
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="footer-widget footer-menu">
                ...
                <ul>
                  <li><a href="{{ route('register_job_seeker') }}"><i class="fas fa-angle-double-right"></i> @lang('app.create_account')</a>
                  </li>
                  <li><a href=""><i class="fas fa-angle-double-right"></i>
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="footer-widget footer-menu">
                ...
                <ul>
                  <li><a href="{{ route('register_employer') }}"><i class="fas fa-angle-double-right"></i> @lang('app.create_account')</a>
                  </li>
