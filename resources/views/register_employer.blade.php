      ...
      <div class="account-content py-5">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 col-lg-6 login-left">
            <img src="{{ asset('assets/img/app/company-banner.svg') }}" class="img-fluid" alt="Doccure Register">
          </div>
          <div class="col-md-12 col-lg-6 login-right">
            <div class="login-header">
              <h3>{{ __('app.register') }} <a class="text-primary" href="{{ route('register_job_seeker') }}">{{ __('app.register_jobseeker') }}?</a>
              </h3>
            </div>
            ...
            <form method="POST" action="">
              ...
              <div class="form-group form-focus">
                <input id="company" type="text" class="form-control floating {{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" value="{{ old('company') }}" required autofocus>
                <label class="focus-label">{{ __('app.company') }}</label>
