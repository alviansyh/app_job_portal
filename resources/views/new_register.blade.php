      ...
      <div class="row justify-content-md-center">
        ...
        <div class="col-md-4">
          <div class="register-account-box jf-shadow p-3">
            ...
            <a href="{{ route('register_job_seeker') }}" class="btn btn-main"><i class="la la-user-plus"></i> @lang('app.register_account') </a>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="register-account-box jf-shadow  p-3">
            ...
            <a href="{{ route('register_employer') }}" class="btn btn-main"><i class="la la-user-plus"></i> @lang('app.register_account') </a>
          </div>
        </div>
