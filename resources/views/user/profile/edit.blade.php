    ...
    <div class="card-body pt-0">
      ...
      <nav class="user-tabs mb-4">
        <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('profile_settings') }}">{{ __('app.profile') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('profile_experience') }}">{{ __('app.user_experience') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('profile_education') }}">{{ __('app.user_education') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('profile_skill') }}">{{ __('app.user_skill') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('profile_language') }}">{{ __('app.user_language') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('profile_addtional') }}">{{ __('app.user_additional_info') }}</a>
          </li>
        </ul>
      </nav>
      <!-- /Tab Menu -->
      ...
      <div class="tab-content pt-0">
        ...
        <div class="tab-fane fade show active">
                  ...
                  <div class="row form-row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">@lang('app.address_2')</label>
                        <input type="text" class="form-control {{ $errors->has('address_2') ? ' is-invalid' : '' }}" id="address_2" name="address_2"
                          value="{{ old('address_2', $user_info->address_2) }}">
                        @if ($errors->has('address_2'))
                          <div class="invalid-feedback">
                            <strong>{{ $errors->first('address_2') }}</strong>
                          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row form-row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label></label>
                        <textarea class="form-control {{ $errors->has('about_me') ? ' is-invalid' : '' }}" rows="12" id="about_me"
                          name="about_me">{{ old('about_me', $user_info->about_me) }}</textarea>
