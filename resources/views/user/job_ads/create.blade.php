...
@section('content')
  ...
  <form method="POST" action="">
        ...
        <div class="row form-row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('job_title') ? ' is-invalid' : '' }}" id="job_title" name="job_title" value="{{ old('job_title') }}" autofocus>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" data-role="tagsinput" class="input-tags form-control {{ $errors->has('skills') ? ' is-invalid' : '' }}" id="skills" name="skills" value="{{ old('skills') }}">
            ...
            <div class="form-group">
              ...
              <select class="form-control select {{ $errors->has('job_type') ? ' is-invalid' : '' }}" id="job_type" name="job_type">
                ...
                @foreach (job_types() as $job_type_id => $job_type)
                  <option value="{{ $job_type_id }}" {{ selected($job_type_id, old('job_type')) }}>
                    {{ $job_type }}</option>
                @endforeach
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control select {{ $errors->has('gender') ? ' is-invalid' : '' }}" id="gender" name="gender">
                ...
                @foreach (gender() as $gender_id => $gender)
                  <option value="{{ $gender_id }}" {{ selected($gender_id, old('gender', 'not_specified')) }}>
                    {{ $gender }}</option>
                @endforeach
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control select {{ $errors->has('exp_level') ? ' is-invalid' : '' }}" id="exp_level" name="exp_level">
                ...
                @foreach (exp_levels() as $level_id => $level)
                  <option value="{{ $level_id }}" {{ selected($level_id, old('exp_level', 'junior')) }}>
                    {{ $level }}</option>
                @endforeach
              </select>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control {{ $errors->has('experience_required_years') ? ' is-invalid' : '' }}" id="experience_required_years" name="experience_required_years"
                  value="{{ old('experience_required_years', 0) }}">
                <span class="input-group-text">@lang('app.in_years')</span>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="min_experience" name="min_experience" value="1" {{ checked('1', old('min_experience')) }}>
        ...
        <div class="row form-row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control {{ $errors->has('qualification') ? ' is-invalid' : '' }}" rows="12" id="qualification" name="qualification">{{ old('qualification') }}</textarea>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control {{ $errors->has('benefits') ? ' is-invalid' : '' }}" rows="12" id="benefits" name="benefits">{{ old('benefits') }}</textarea>
        ...
        <div class="row form-row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('city_name') ? ' is-invalid' : '' }}" id="city_name" name="city_name" value="{{ old('city_name', $company_info->city) }}">
        ...
        <div class="row form-row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="number" class="form-control {{ $errors->has('vacancy') ? ' is-invalid' : '' }}" id="vacancy" name="vacancy" value="{{ old('vacancy', 1) }}">
            ...
            <div class="form-group">
              ...
              <select class="form-control select {{ $errors->has('salary_cycle') ? ' is-invalid' : '' }}" id="salary_cycle" name="salary_cycle">
                ...
                @foreach (salary_cycle() as $level_id => $level)
                  <option value="{{ $level_id }}" {{ selected($level_id, old('salary_cycle', 'monthly')) }}>
                    {{ $level }}</option>
                @endforeach
              </select>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('salary') ? ' is-invalid' : '' }}" id="experience_required_years" name="salary" value="{{ old('salary') }}">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="is_negotiable" name="is_negotiable" value="1" {{ checked('1', old('is_negotiable')) }}>
                <label class="form-check-label">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('salary_upto') ? ' is-invalid' : '' }}" id="salary_upto" name="salary_upto" value="{{ old('salary_upto') }}">
    ...
    <div class="submit-section submit-btn-bottom">
      <button type="submit" class="btn btn-primary submit-btn">@lang('app.post_new_job')</button>
    </div>
  </form>
@endsection
