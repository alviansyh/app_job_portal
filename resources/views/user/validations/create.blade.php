        ...
        <div class="row form-row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control  {{ $errors->has('validation_number') ? ' is-invalid' : '' }}" id="validation_number" name="validation_number" value="{{ old('validation_number') }}" autofocus>
